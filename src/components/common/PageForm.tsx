...
export default function PageForm({children}:any){
  return(
    <form onSubmit={submitHandler} 
      className="w-full flex flex-wrap justify-between gap-4 pt-4">
      ...
      <div className="w-full flex flex-col md:w-fit">
        ...
        <select className="bg-secondary text-primary text-sm rounded-lg focus:ring-none w-full md:w-64 p-2.5" 
          name="Cargos" 
          required>
            <option value="" disabled={false}  hidden={false}></option>
