...
export default function PageForm({children}:any){
  return(
    <form onSubmit={submitHandler} className="w-full flex flex-wrap justify-between gap-4 pt-4">
            <div className="w-full md:w-fit">
              <label htmlFor="nombre" 
                className="block font-medium ">
                Nombre completo*
              </label>
              <input className="bg-secondary text-primary text-sm rounded-lg focus:ring-none   w-full md:w-64 p-2.5" 
                required 
                type="text" 
                name="nombre" 
                id=""/>
            ...
            <div className="w-full flex flex-col md:w-fit">
              <label htmlFor="cargo" className="font-medium w-full">
                Cargo*
              </label>
              <select className="bg-secondary text-primary text-sm rounded-lg focus:ring-none w-full md:w-64 p-2.5" name="Cargos" required>
                  <option value="" disabled={false} selected={false} hidden={false}></option>
                  ...
                  <option value="Director(a) Comercial">
                  ...
                  <option value="Técnico de Operaciones">
                    Técnico de Operaciones
                  </option>
                  <option value="Director(a) de Compras">
                  ...
                  <option value="Analista de Negocios">
                    Analista de Negocios
                  </option>
                  <option value="CEO/Fundador/Socio">
                    CEO/Fundador/Socio
                  </option>
                  <option value="Estudiante/Becario(a)">
                    Estudiante/Becario(a)
                  </option>
                  <option value="Otros Cargos">
                    Otros Cargos
                  </option> 
                </select>
            </div>
            <div className="w-full md:w-fit">
              ...
              <input className="bg-secondary text-primary text-sm rounded-lg focus:ring-non w-full md:w-64 p-2.5" 
                type="text" 
                name="nombreEmpresa" 
                id=""/>
            </div>
            <div className="w-full md:w-fit">
              <label htmlFor="areaMercado" 
                className="block font-medium ">
                Area de mercado*
              </label>
              <select className="bg-secondary text-primary text-sm rounded-lg focus:ring-none w-full md:w-64 p-2.5" name="mercado"  required>
                <option value="" disabled={false} selected={false} hidden={false}></option>
                ...
                <option value="Plastico y Caucho">
                  Plastico y Caucho
                </option>
                ...
                <option value="Servicios Publicos">
                  Servicios Publicos
                </option>
                <option value="Metalurgia y Mineria">
                ...
                <option value="Textil y confecciones">
                  Textil y confecciones
                </option>
                <option value="Transporte y Logistica">
            ...
            <div className="w-full pl-10 pt-4">
              ...
              <label htmlFor="privacidad">
                ...
                <a href="politicasPrivacidad" className="font-bold text-emerald-300">Politicas de Privacidad</a>
              </label>
            </div>
            <div className="w-full pl-10 pt-4">
              {children}
